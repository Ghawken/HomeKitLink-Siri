"""Base functionality of ffmpeg  wrapper."""
import asyncio
import functools
import logging
import re
...
class IndigoFFmpeg:
    ...
    async def open(
        ...
        # start ffmpeg
        _LOGGER.debug("Start ** IndigoFFmpeg with %s", str(self._argv))
        try:
    ...
    def kill(self) -> None:
        ...
        try:
            ...
            _LOGGER.debug(f"Exception Killing ffmpeg job likely doesnt exist", exc_info=True)
...
class IndigoFFmpegWorker(IndigoFFmpeg):
